...
# http_pagespeed (https://github.com/pagespeed/ngx_pagespeed, Apache 2.0 license)
HTTP_PAGESPEED_MODULE_PV="release-1.5.27.2-beta"
HTTP_PAGESPEED_MODULE_P="ngx_pagespeed-${HTTP_PAGESPEED_MODULE_PV}"
HTTP_PAGESPEED_MODULE_URI="https://0x1.fr/files/ngx_pagespeed/${HTTP_PAGESPEED_MODULE_P}-bundle.tar.gz"
...
CDEPEND="
	...
	nginx_modules_http_pagespeed? ( >=dev-libs/libpcre-4.2 sys-libs/zlib )"
RDEPEND="${CDEPEND}"
DEPEND="${CDEPEND}
